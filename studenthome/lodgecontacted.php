...
<head>
	...
	<title>Schoolcrib-lodgecontacted</title>
    ...
    <!--  Schoolcrib core CSS    -->
    <link href="assets/css/pagecss/lodgecontacted.css" rel="stylesheet"/>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Lodges Contacted</a>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-7 col-sm-12">
                        <div id="contacted_con">
                            <div id="contacted_header">
                                
                                <b1>Lodges Contacted</b1>
                                <i class="ti-headphone-alt"></i>
                            </div>
                            <div id="saved_body">
